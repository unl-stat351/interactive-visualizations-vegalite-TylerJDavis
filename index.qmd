...
> I think possible displaying a graph that fills more of the area such as a heat map showing the slow change in color would hopefully create a good visual.

Is your proposed graphic supported by vega-lite? Why or why not? (You can provide links to documentation/stackOverflow)

> The heat map on vega can be found on the website listed below.
>
> [2D Histogram Heatmap \| Vega-Lite](https://vega.github.io/vega-lite/examples/rect_binned_heatmap.html)
